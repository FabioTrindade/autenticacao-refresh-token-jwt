...
namespace RefreshTokenAuth.Services
{
    public static class TokenService
    {
        ...
        {
            _refreshToken.Add(new(username, refreshToken));
        }

        public static string GetRefreshToken(string username)
        {
            return _refreshToken.FirstOrDefault(x => x.Item1 == username).Item2;
        }

        public static void DeleteRefreshToken(string username, string refreshToken)
        {
            var item = _refreshToken.FirstOrDefault(x => x.Item1 == username && x.Item2 == refreshToken);
